...
```json
{
  "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJhdXRlbnRpY2FjYS1hcGkiLCJzdWIiOiIwMDczMjk2MjAxMyIsImV4cCI6MTcyOTU5NzQ1NH0.Egw_8y29quJi6d289Jj2ZJEaTs3XWY4WNvZt6vTPN6g",
  "id": 1,
  "nome": "Carlos Nazario"
}
```
